...
const Suppliers = () => {
  const { suppliers = [], isLoading: loading, addSupplier, updateSupplier, deleteSupplier } = useSuppliers();
  ...
  const handleSubmit = (e) => {
    ...
    if (editingSupplier) {
      updateSupplier({ id: editingSupplier.id, supplierData: formData }, mutationOptions);
    } else {
      addSupplier(formData, mutationOptions);
    }
  };
