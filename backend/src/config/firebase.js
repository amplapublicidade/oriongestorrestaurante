...
// Preferência: GOOGLE_APPLICATION_CREDENTIALS (application default).
// Fallback: variáveis FIREBASE_* (para compatibilidade com ambientes que não suportam Secret Files).
